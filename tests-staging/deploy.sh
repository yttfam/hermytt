...
$SCP "$TARGET_DIR/$TARGET/release/hermytt-server" "$HOST:/opt/hermytt/hermytt-server"
$SCP "$TARGET_DIR/$TARGET/release/shytti" "$HOST:/opt/shytti/shytti"
$SCP "$TARGET_DIR/$TARGET/release/grytti" "$HOST:/opt/grytti/grytti"
